...
extern const MIDL_SERVER_INFO WindowsSudoRpc_ServerInfo;
...
extern const RPC_DISPATCH_TABLE WindowsSudoRpc_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE WindowsSudoRpc___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xa0fe973e,0xeec7,0x4190,{0xac,0x8b,0x60,0x31,0x1b,0xb5,0x98,0x95}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&WindowsSudoRpc_v1_0_DispatchTable,
    1,
    (RPC_PROTSEQ_ENDPOINT *)__RpcProtseqEndpoint,
    0,
    &WindowsSudoRpc_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE WindowsSudoRpc_v1_0_s_ifspec = (RPC_IF_HANDLE)& WindowsSudoRpc___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION WindowsSudoRpc_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE WindowsSudoRpc_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)WindowsSudoRpc_table
    };
...
static const MIDL_STUB_DESC WindowsSudoRpc_StubDesc = 
    {
    (void *)& WindowsSudoRpc___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& WindowsSudoRpc_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION WindowsSudoRpc_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE WindowsSudoRpc_NDR64__v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)WindowsSudoRpc_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO WindowsSudoRpc_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&WindowsSudoRpc_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE WindowsSudoRpc_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)WsrCreateProcessWithLogon,
    (SERVER_ROUTINE)WsrCreateProcessAsElevated
    };

static const MIDL_SERVER_INFO WindowsSudoRpc_ServerInfo = 
    {
    &WindowsSudoRpc_StubDesc,
    WindowsSudoRpc_ServerRoutineTable,
    WindowsSudoRpc__MIDL_ProcFormatString.Format,
    (unsigned short *) WindowsSudoRpc_FormatStringOffsetTable,
    0,
